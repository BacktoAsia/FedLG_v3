...
## --------------------------------------------------
def mnist():
    trainset = datasets.MNIST('/home/Data1/Natural', train=True, download=True,
                       transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ]))

    testset = datasets.MNIST('/home/Data1/Natural', train=False, transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,))
        ]))
...
def fmnist():
    trainset = datasets.FashionMNIST('/home/Data1/Natural', train=True, download=True,
                       transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ]))

    testset = datasets.FashionMNIST('/home/Data1/Natural', train=False, transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,))
        ]))
...
def emnist():
    trainset = datasets.EMNIST('/home/Data1/Natural', 'byclass', train=True, download=True,
                              transform=transforms.Compose([
                                  transforms.ToTensor(),
                                  transforms.Normalize((0.1307,), (0.3081,))
                              ]))

    testset = datasets.EMNIST('/home/Data1/Natural', 'byclass', train=False, transform=transforms.Compose([
        transforms.ToTensor(),
        transforms.Normalize((0.1307,), (0.3081,))
    ]))
...
def cifar10():
    ...
    trainset = datasets.CIFAR10(
        root='/home/Data1/Natural', train=True, download=True, transform=transform_train)  #
    testset = datasets.CIFAR10(
        root='/home/Data1/Natural', train=False, download=True, transform=transform_test)
...
def cinic10():
    ...
    trainset = datasets.ImageFolder(
        root='/home/Data1/Natural/CINIC-10/train', transform=transform_train)  #
    testset = datasets.ImageFolder(
        root='/home/Data1/Natural/CINIC-10/test', transform=transform_test)
...
def cinic10_cifar():
    ...
    trainset = datasets.ImageFolder(
        root='/home/Data1/Natural/CINIC-10-CIFAR/train', transform=transform_train)  #
    testset = datasets.ImageFolder(

        root='/home/Data1/Natural/CINIC-10-CIFAR/test', transform=transform_test)
...
def cinic10_imagenet():
    ...
    trainset = datasets.ImageFolder(
        root='/home/Data1/Natural/CINIC-10-ImageNet/train', transform=transform_train)  #
    testset = datasets.ImageFolder(

        root='/home/Data1/Natural/CINIC-10-ImageNet/test', transform=transform_test)
...
def get_dataset(args):
    ...
    if args.dataset not in ['cinic_sep']:
        ...
        global_train_loader = DataLoader(train_dataset, batch_size=args.local_bs, shuffle=False)
        ...
        global_train_loader = DataLoader(train_dataset1, batch_size=args.local_bs, shuffle=False)
